...
function preload() {
  ...
  playerImg = loadAnimation("character2back.png");
  ...
  gameoverimg = loadImage("ni.jpg")
  
  coinsimg = loadAnimation("coin1.png");
  
  birdsimg = loadAnimation("bird1.png");
  
  snakeimg = loadAnimation("snake1.png")
}
